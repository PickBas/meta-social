# Generated by Django 3.0.4 on 2020-04-08 07:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('artist', models.CharField(default='Автор неизвестен', max_length=100)),
                ('title', models.CharField(default='Название неизвестно', max_length=100)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
