...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='ConversationM',
            fields=[
                ('chat_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='meta_social_app.Chat')),
                ('conversation_name', models.CharField(max_length=50, null=True)),
            ],
            bases=('meta_social_app.chat',),
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
