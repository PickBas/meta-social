...
urlpatterns = [
    ...
    path('friends/send_request/<int:user_id>/', login_required(FriendsViews.send_friendship_request)),
    path('friends/accept_request/<int:user_id>/', login_required(FriendsViews.accept_request)),
